...
import {
  ...
  depositePAWS,
  getPAWSAmount,
  getPAWSDepositeAmount,
  getPAWSTotalDepositeAmount,
  getPAWZAmount,
  isClaimEnabled,
...
function App() {
  ...
  let [PAWSDepositeTotalAmount, setPAWSDepositeTotalAmount] =
    useState("0.0000");
    ...
    <>
      ...
      <div className="funding-box first-box">
        ...
        <div className="right-header">
          ...
          <p className="audited">
            Audited by{" "}
            <a href="https://github.com/lemoncrypto" target="_blank">
              LemonCrypto
            </a>
          </p>
        </div>
      ...
      <div className="funding-box">
        <div className="left-half">
          {loginStatus ? (
            ...
            <>
              ...
              <p className="warning-box">
                Please connect to BSC Network and refresh!
              </p>
            </>
          )}
          ...
          <p className="description">
            $PAWZ is a next generation of $PAWS, community-focused,
            decentralized cryptocurrency with instant rewards thanks to active
            users! Join the moon mission.
          </p>

          <p className="text-center">
            <a
              className="pink-text"
              href={`https://bscscan.com/address/${SWAPContractAddress}`}
              target="_blank"
            >
              View Smart Contract
            </a>
          ...
          <p>
            Total Raised:{" "}
            <span className="raised">{PAWSDepositeTotalAmount} PAWS</span>
          </p>
          <p>
            My Contribution:{" "}
            <span className="raised">{PAWSDepositeAmount} PAWS</span>
          </p>
          <p>
            PAWZ Token :{" "}
            <a
              href={`https://bscscan.com/token/${PAWZTokenAddress}`}
              target="_blank"
            >
              {PAWZTokenAddress}
            </a>
          ...
          <div className="claim">
            <p className="description">Deposit your PAWS tokens</p>
            <button onClick={tryDepositePAWS}>Deposit PAWS</button>
          </div>
          {claimEnabled && (
            <div className="claim">
          ...
          <div>
            <div className="how-many">
              ...
              <p>
                The amount of tokens you will receive will be 1 PAWZ Token per 1
                Million PAWS Token.
              </p>
            </div>
          </div>
